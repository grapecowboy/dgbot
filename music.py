...
def main():
	...
	helpmessage = bar + "\n\n" + "Specify profession with option --prof with an integer" +"\n" + "1 through 26" +"\n\n" + "Specify previous profession with option --b4 an integer" + "\n" + "1 through 40" + "\n\n\n"

	if botarguments == None:
		print("BOT IS IN RANDOM MODE")
		args = parser.parse_args()
	else:
		print("BOT IS IN NON-RANDOM MODE")
		args = parser.parse_args( botarguments )
